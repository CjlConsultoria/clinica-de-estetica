...
interface TermoForm {
  paciente: string; cpf: string; nascimento: string; procedimento: string;
  dataProcedimento: string; profissional: string; email: string;
}
...
function isFormDirty(form: TermoForm): boolean {
  return (
    ...
    form.procedimento !== '' || form.dataProcedimento !== '' ||
...
export default function Consentimento() {
  ...
  function handleChange(field: keyof TermoForm, value: string) { setForm(prev => ({ ...prev, [field]: value })); clearError(field as TermoField); }
  function handleMaskedChange(field: keyof TermoForm, value: string) { setForm(prev => ({ ...prev, [field]: value })); clearError(field as TermoField); }
  ...
  return (
    <Container>
      ...
      <StatsGrid>
        <StatCard label="Total de Termos" value={totalTermos} color="#BBA188" icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>} />
        ...
        <StatCard label="Pendentes"      value={pendentes}   color="#d4a84b" icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>} trend={{ value: 'Aguardando', positive: false }} />
