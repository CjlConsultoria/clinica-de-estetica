...
public class EstoqueService {
    ...
    private LoteResponse toResponse(LoteProduto lote) {
        return LoteResponse.builder()
                ...
                .produtoEstoqueMinimo(lote.getProduto().getEstoqueMinimo())
                .produtoEstoqueMaximo(lote.getProduto().getEstoqueMaximo())
                .produtoPrecoUnitario(lote.getProduto().getPrecoUnitario())
